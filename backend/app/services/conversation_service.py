...
from app.schemas.conversation import ConversationRequest, EditingContext
...
class ConversationService:
    ...
    async def process_conversation(
        ...
        update_data = {
            ...
            "extractedInfo": result["extractedInformation"],
            "rbacValidation": result.get("rbacValidation", {}),
            "isComplete": result["isComplete"],
            "confidenceScore": result.get("confidenceScore", 0),
            "conversationState": result.get("conversationState", "gathering"),
