...
from app.db.models import ConversationDocument, ConversationMessage
...
class ConversationRepository:
    ...
    async def reset_conversation(self, session_id: str) -> ConversationDocument:
        ...
        Raises:
            NotFoundException: If conversation not found
        """
        from app.db.models import ExtractedInformation, RBACValidation
