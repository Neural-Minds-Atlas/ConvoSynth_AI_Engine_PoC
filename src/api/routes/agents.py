    ...
    **Session Management:**
    ...
    try:
        ...
        if not session_id:
            ...
            logger.info(
                "new_generation_session_created",
                session_id=session_id,
                user_id=conversation_request.user_profile.user_id,
                role=conversation_request.user_profile.role
            )
    ...
    **Session Management:**
    ...
    try:
        ...
        if not session_id:
            ...
            logger.info(
                "new_editing_session_created",
                session_id=session_id,
                user_id=conversation_request.user_profile.user_id,
                target_slide=conversation_request.editing_context.target_slide
            )
